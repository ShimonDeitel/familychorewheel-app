...
struct ContentView: View {
    ...
    @State private var editingItem: Chore?
    ...
    var body: some View {
        NavigationStack {
            ...
            .navigationTitle("Family Chore Wheel")
            .toolbar {
...
struct EditItemView: View {
    ...
    var body: some View {
        NavigationStack {
            Form {
                Section("AssignedTo") {
                    TextField("AssignedTo", text: $field1)
            ...
            .navigationTitle(item == nil ? "Add Chore" : "Edit Chore")
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") {
                        var new = item ?? Chore(assignedTo: "", note: "")
                        new.assignedTo = field1
                        new.note = field2
                        onSave(new)
                        dismiss()
                    }
